...
CREATE TABLE IF NOT EXISTS USUARIO (
	...
	e_mail varchar(43) NOT NULL,
	tipo_usu varchar(2) NOT NULL,
	CONSTRAINT USUARIO_pk0 PRIMARY KEY (id_usuario),
    CONSTRAINT USUARIO_ak0 UNIQUE (tipo_doc) NOT DEFERRABLE INITIALLY IMMEDIATE,
    CONSTRAINT USUARIO_ak1 UNIQUE (nro_doc) NOT DEFERRABLE INITIALLY IMMEDIATE
);
...
CREATE TABLE IF NOT EXISTS CON_CARNET (
    ...
    CONSTRAINT CON_CARNET_ak0 UNIQUE (nro_carnet) NOT DEFERRABLE INITIALLY IMMEDIATE
);
